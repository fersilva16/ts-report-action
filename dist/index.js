...
var require_file_command = __commonJS({
  "node_modules/.pnpm/@actions+core@1.8.2/node_modules/@actions/core/lib/file-command.js"(exports) {
    ...
    var fs = __importStar(__nccwpck_require__(747));
    var os = __importStar(__nccwpck_require__(87));
    var utils_1 = require_utils();
...
var require_lib = __commonJS({
  "node_modules/.pnpm/@actions+http-client@2.0.1/node_modules/@actions/http-client/lib/index.js"(exports) {
    ...
    var http = __importStar(__nccwpck_require__(605));
    var https = __importStar(__nccwpck_require__(211));
...
var require_lib3 = __commonJS({
  "node_modules/.pnpm/node-fetch@2.6.7/node_modules/node-fetch/lib/index.js"(exports, module2) {
    ...
    var convert;
    try {
      convert = __nccwpck_require__(710).convert;
    } catch (e) {
    }
...
var import_child_process = __nccwpck_require__(129);
var import_util = __nccwpck_require__(669);
var debugConsole = (obj) => {
  return (0, import_core.debug)((0, import_util.inspect)(obj, true, null, true));
};
var check = async (ghToken, files) => {
  debugConsole({
    ghToken,
    files
  });
  ...
  if (!prNumber) {
    (0, import_core.setFailed)("Not in PR");
    return;
  }
  const result = (0, import_child_process.spawnSync)("yarn", [
    "--silent",
    "tsc-files",
    "--noEmit",
    ...files
  ...
  if (result.error) {
    (0, import_core.setFailed)(result.error);
    return;
  }
...
(async () => {
  try {
    const ghToken = (0, import_core.getInput)("githubToken");
